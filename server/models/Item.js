...
const itemSchema = new Schema({
   make: {type: String, required: true, minlength: [3, 'Make must be at least 4 characters long']},
   model: {type: String, required: true, minlength: [3, 'Make must be at least 4 characters long']},
